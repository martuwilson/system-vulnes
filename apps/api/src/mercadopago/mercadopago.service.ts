...
export class MercadopagoService {
  ...
  async createSubscription(
    ...
    // MercadoPago tiene un sistema de suscripciones separado
    // Por ahora usamos preferencias de pago únicas
    // En producción implementarías preapprovals (suscripciones automáticas)
    
    this.logger.log(`Creating subscription for user ${userId}, plan ${plan}`);
    
    // TODO: Implementar preapprovals de MercadoPago
